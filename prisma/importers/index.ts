...
import { importFolhasCr2Presenca } from './31-folhas-cr2-presenca'
...
const ALL_PHASES = [
  ...
  'wordpress', 'paginas-wp', 'institucional-paginas', 'atas-historicas', 'drive', 'texto', 'ocr',
] as const
...
async function main() {
  ...
  if (selected('folhas-cr2', only)) await importFolhasCr2Presenca(ctx)
