...
export const parlamentaresData: Parlamentar[] = [
  {
    ...
    partido: 'MDB',
    biografia: 'Francisco Pereira Pantoja, popularmente conhecido como "Pantoja do Cartório", nascido em 19 de novembro de 1945, filho de Nery da Costa Pantoja e Tertuliana Dias Pereira; casado, pai e avô; residente no município há 48 anos. Tem como formação acadêmica o Bacharelado em Administração de Empresas e Bacharelado em Direito, pela FIT (Faculdades Integradas do Tapajós), hoje UNAMA (Universidade da Amazônia). É oficial Titular do Cartório de Registro Civil das Pessoas Naturais e Notas; e Vereador (2021 -2024). Seu entusiasmo pela carreira política começou quando, o mesmo, fez parte da comissão de Emancipação do município, como Vice-presidente, onde logrou êxito. Disputou, como candidato a vereador, as eleições de 2021 e conseguiu eleger-se com mais de 452 votos; hoje eleito, vem potencializando os trabalhos voltados ao bem-estar da população, além de compartilhar com todos o conhecimento que conquistou ao longo de toda vida trabalhando na área jurídica.',
    ...
    ordemDoDia: [
      {
        ...
        descricao: 'Institui o Conselho Municipal de Educação',
...
export const audienciasPublicasData: AudienciaPublica[] = [
  {
    ...
    transmissaoAoVivo: {
      ativa: true,
      url: 'https://youtube.com/live/camara',
      plataforma: 'YouTube',
      status: 'AGENDADA'
    },
    inscricoesPublicas: {
...
export const proposicoesData: Proposicao[] = [
  {
    ...
    textoCompleto: 'Art. 1º Fica instituído o Conselho Municipal de Educação, órgão colegiado de natureza consultiva, deliberativa e fiscalizadora...',
    autorId: '2',
    coautores: ['3', '4'],
