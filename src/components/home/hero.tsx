              ...
              >
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-white/20 flex items-center justify-center mb-3 sm:mb-4 group-hover:bg-white/30 transition-colors">
                    ...
                    <div className="mt-3 sm:mt-4 flex items-center gap-1 text-white/60 group-hover:text-white/90 transition-colors text-xs sm:text-sm font-medium">
                      Acessar <ArrowRight className="h-3.5 w-3.5 sm:h-4 sm:w-4 group-hover:translate-x-1 transition-transform" />
                    </div>
                  </div>
                </div>
              </Link>
