...
import { ArrowLeft, GraduationCap, Loader2, Search } from 'lucide-react'
...
export default function EstagiariosPage() {
  ...
  return (
    <TransparenciaPageWrapper slug="estagiarios" nome="Estagiarios">
      <div className="container mx-auto px-4 py-8 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Relacao de Estagiarios</h1>
            <p className="text-sm text-muted-foreground">Estagiarios da Camara Municipal</p>
          </div>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            {loading ? (
              ...
              <p className="text-center py-12 text-muted-foreground">Nenhum estagiario cadastrado.</p>
            ) : (
