 ...
 *
 * Modo "Sessao existente": admin escolhe na lista (carrega de /api/sessoes).
 * Modo "Criar sessao": admin informa numero+tipo+data; backend cria a Sessao
 * automaticamente como FINALIZADA antes de anexar a ata.
 */
...
export default function PublicarAtaPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSubmitting(true)
    try {
      const r = await fetch('/api/sessoes/publicar-ata', {
        method: 'POST',
    ...
    <div className="container mx-auto px-4 py-6 max-w-3xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center gap-2">
          ...
          Publicar Ata da Sessão
        </h1>
        <p className="text-gray-600 mt-1">
          Anexe o PDF da ata aprovada a uma sessão. Se a sessão ainda não existe, ela
          será criada automaticamente como finalizada.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {modo === 'existente' ? (
              ...
              <>
                ...
                <p className="text-xs text-gray-500">
                  ...
                  encontrar, cria uma nova com status “Concluída” e finalizada=true.
                </p>
              </>
            )}
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">2. Ata</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">
                Data oficial em que a ata foi publicada. RN-123 PNTP exige prazo máximo
                de 15 dias após a aprovação.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Notas internas, motivo retroativo, etc"
              />
            </div>
          </CardContent>
        </Card>
