...
export default function PublicarPautaReuniaoPage() {
  ...
  async function handleUpload(file: File) {
    ...
    fd.append('file', file)
    fd.append('folder', 'pautas-reunioes-comissao')
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSubmitting(true)
    try {
      const r = await fetch('/api/reunioes-comissao/publicar-pauta', {
        method: 'POST',
    ...
    <div className="container mx-auto px-4 py-6 max-w-3xl">
      <div className="mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex items-center gap-2">
          ...
          Publicar Pauta de Reunião de Comissão
        </h1>
        <p className="text-gray-600 mt-1">
          Anexe o PDF da pauta a uma reunião de comissão. Se a reunião ainda não
          existe, ela será criada automaticamente.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">3. Pauta</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">
                RN-122 PNTP exige publicação 48h antes da reunião.
              </p>
            </div>
