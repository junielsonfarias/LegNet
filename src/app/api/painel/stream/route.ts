...
// SSE retorna Response nativo (nao NextResponse) - nao pode usar withErrorHandler
export async function GET(request: NextRequest) {
  try {
    ...
    if (!sessaoId) {
      return NextResponse.json({ success: false, error: 'sessaoId e obrigatorio' }, { status: 400 })
    }
      ...
      async start(controller) {
        ...
        const sendEvent = (event: string, data: unknown) => {
          ...
          try {
            ...
            // Conexao SSE fechada pelo cliente - esperado
          }
        }
        ...
        const sendHeartbeat = () => {
          ...
          try {
            ...
            // Heartbeat SSE falhou - conexao fechada pelo cliente
          }
        }
        ...
        const poll = async () => {
          ...
          try {
            ...
            // Erro no polling SSE - tentara novamente no proximo ciclo
          }
    ...
    return NextResponse.json({ success: false, error: 'Erro ao iniciar stream' }, { status: 500 })
  }
}
