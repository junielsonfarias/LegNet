...
export default function ComparativoPage() {
  ...
  const getRankingColor = (ranking: number) => {
    switch (ranking) {
      ...
      default: return 'bg-camara-primary/10 text-camara-primary border-camara-primary/20'
    }
  }
  ...
  const getRankingIcon = (ranking: number) => {
    switch (ranking) {
      ...
      default: return <Target className="h-4 w-4 text-camara-primary" />
    }
  }
              ...
              <div key={parlamentar.id} className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div>
                      <div className="text-lg font-semibold text-camara-primary">{parlamentar.dados.proposicoes}</div>
